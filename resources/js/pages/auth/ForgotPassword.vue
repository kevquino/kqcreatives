        ...
        <div class="px-6 py-8 sm:px-8 sm:py-10 md:px-10 md:py-12 lg:px-12 lg:py-12 flex flex-col items-center gap-8 sm:gap-10 md:gap-12 w-full backdrop-blur-2xl rounded-2xl bg-white/80 dark:bg-gray-900/80 border border-white/20 dark:border-gray-700/20 shadow-2xl max-w-xs sm:max-w-sm md:max-w-md">
            <div class="flex flex-col items-center gap-4 w-full">
                ...
                <div class="flex flex-col gap-2 w-full">
                    <div class="text-center text-2xl sm:text-3xl font-medium text-gray-900 dark:text-white leading-tight">Reset Password</div>
            ...
            <div class="space-y-6 w-full">
                <Form v-bind="email.form()" v-slot="{ errors, processing }" class="w-full">
                    <div class="flex flex-col gap-6 w-full">
                        ...
                        <div class="flex items-center justify-start">
                            <Button
                                class="w-full rounded-3xl bg-blue-600 hover:bg-blue-700 border border-blue-600 text-white h-12 sm:h-14 text-base sm:text-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
                                :disabled="processing"
